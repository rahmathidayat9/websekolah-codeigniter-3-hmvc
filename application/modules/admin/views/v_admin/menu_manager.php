            ...
            <div class="card-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= $menu['menu'] ?></td>
                  <td>
                    <a onclick="return confirm('Yakin ?')" href="<?= base_url('admin/Menu_Manager/delete_menu/').$menu['id_menu'] ?>" class="badge badge-danger">
                      hapus
                    </a>
                  </td>
                </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('admin/Menu_Manager/add_menu') ?>">
